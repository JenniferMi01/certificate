...
// import { DatePickerInput } from "@mantine/dates"; // ✅ AJOUT import DatePickerInput
...
//   // ✅ Historique des postes avec période (plage de dates)
...
//       {/* ✅ Historique des postes avec DatePickerInput range */}
...
//             {/* ✅ Historique des postes dans le PDF */}
...
//                     {poste.periode[0] && (
//                       <> du <strong>{new Date(poste.periode[0]).toLocaleDateString('fr-FR')}</strong></>
//                     )}
//                     {poste.periode[1] && (
//                       <> au <strong>{new Date(poste.periode[1]).toLocaleDateString('fr-FR')}</strong></>
//                     )}
//                   </p>
//                 ))
//               ) : (
...
//                 Date d'embauche :{" "}
//                 <strong>
//                   {new Date(selectedEmployee.start_date).toLocaleDateString('fr-FR')}
//                 </strong>
//               </p>
//             )}
